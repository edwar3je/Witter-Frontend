...
class WitterApi {
    ...
    static async getProfile(handle) {
        try {
            const result = await axios.get(`${BASE_URL}/profile/${handle}`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async editProfile(handle, formData, token) {
        try {
            const result = await axios.put(`${BASE_URL}/profile/${handle}/edit`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async deleteAccount(handle, token) {
        try {
            const result = await axios.delete(`${BASE_URL}/profile/${handle}/edit`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    */
    ...
    static async getWeets(handle, token) {
        try {
            const result = await axios.get(`${BASE_URL}/profile/${handle}/weets`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async getReweets(handle, token) {
        try {
            const result = await axios.get(`${BASE_URL}/profile/${handle}/reweets`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async getFavorites(handle, token) {
        try {
            const result = await axios.get(`${BASE_URL}/profile/${handle}/favorites`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async getTabs(handle, token) {
        try {
            const result = await axios.get(`${BASE_URL}/profile/${handle}/tabs`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    */
    ...
    static async getFollowing(handle, token) {
        try {
            const result = await axios.get(`${BASE_URL}/profile/${handle}/following`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async getFollowers(handle, token) {
        try {
            const result = await axios.get(`${BASE_URL}/profile/${handle}/followers`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async searchUsers(search, token) {
        try {
            const result = await axios.post(`${BASE_URL}/user/${search}`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    */
    ...
    static async follow(handle, token) {
        try {
            const result = await axios.post(`${BASE_URL}/user/${handle}/follow`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async unfollow(handle, token) {
        try {
            const result = await axios.post(`${BASE_URL}/user/${handle}/unfollow`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async getFeed(token) {
        try {
            const result = await axios.get(`${BASE_URL}/weets/`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    */
    ...
    static async createWeet(token) {
        try {
            const result = await axios.post(`${BASE_URL}/weets/`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async getWeet(id, token) {
        try {
            const result = await axios.get(`${BASE_URL}/weets/${id}`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async editWeet(id, formData, token) {
        try {
            const result = await axios.put(`${BASE_URL}/weets/${id}`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async deleteWeet(id, token) {
        try {
            const result = await axios.delete(`${BASE_URL}/weets/${id}`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async reweet(id, token) {
        try {
            const result = await axios.post(`${BASE_URL}/weets/${id}/reweet`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async unreweet(id, token) {
        try {
            const result = await axios.post(`${BASE_URL}/weets/${id}/unreweet`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async favorite(id, token) {
        try {
            const result = await axios.post(`${BASE_URL}/weets/${id}/favorite`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async unfavorite(id, token) {
        try {
            const result = await axios.post(`${BASE_URL}/weets/${id}/unfavorite`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async tab(id, token) {
        try {
            const result = await axios.post(`${BASE_URL}/weets/${id}/tab`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
    ...
    static async untab(id, token) {
        try {
            const result = await axios.post(`${BASE_URL}/weets/${id}/untab`);
        } catch (err) {
            console.error("API Error:", err.response);
            let message = err.response.data.error.message;
            throw Array.isArray(message) ? message : [message];
